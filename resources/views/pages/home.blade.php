...
@section('content')
    <x-ui.hero-section
        ...
        :primaryHref="route('shop-attire.collection', 'graduation-attire')"
        ...
        :images="[
            ...
            [
                'src' => 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=1400&q=70',
                'label' => 'Legal Wear',
                'headline' => 'Courtroom-ready legal attire with a premium professional finish.',
            ],
            [
                'src' => 'https://images.unsplash.com/photo-1519491050282-cf00c82424b4?auto=format&fit=crop&w=1400&q=70',
                'label' => 'Church Wear',
    ...
    <section class="container-shell section-md">
        <div class="luxury-grid md:grid-cols-3">
            <article class="surface p-6">
                ...
                <a href="{{ route('shop-attire.collection', 'graduation-attire') }}" class="mt-5 inline-block text-sm font-semibold underline">Shop Graduation Attire</a>
            </article>
            <article class="surface p-6">
            ...
            <article class="surface p-6">
                ...
                <a href="{{ route('shop-attire.collection', 'church-wear') }}" class="mt-5 inline-block text-sm font-semibold underline">Shop Church Wear</a>
            </article>
        </div>
    </section>
    ...
    <section class="container-shell section-md">
        ...
        <div class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            @foreach (range(1, 8) as $client)
                <div class="surface flex min-h-20 items-center justify-center p-5 text-sm font-semibold text-zinc-700">
                    Company Name
                </div>
            @endforeach
        </div>
